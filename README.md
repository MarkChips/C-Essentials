# C Essentials — MagPi "Learn to Code with C"

This repository contains code samples and executables created by following along with chapters in the [MagPi — Learn to Code with C](https://magpi.raspberrypi.com/) guide. Each program here corresponds to an exercise or project covered in the lesson series, providing a hands-on way to learn and explore C programming basics.

## How to Use

1. **Clone the Repository:**
   ```sh
   git clone https://github.com/MarkChips/C-Essentials.git
   cd C-Essentials
   ```
